...
<!-- Menu -->
		...
		<div class="row padding" style="margin: 0px; opacity: 0.8;">
			<div class="col-md-5 alert bg-dark">
				<h1 class="text-warning block"> Nombre d'utilisateurs </h1>
				<p class="text-light"> Voici le nombre : </p>
			</div>
			<div class="col-md-2"></div>
			<div class="col-md-5 alert bg-dark">
				<h1 class="text-warning block"> Nombre de recettes </h1>
				<p class="text-light"> Voici le nombre : </p>
			</div>
		</div>
		<div class="row padding" style="margin: 0px; opacity: 0.8;">
			<div class="col-md-5 alert bg-dark">
				<h1 class="text-warning block"> Date de creation </h1>
				<p class="text-light"> Voici la date : </p>
			</div>
			<div class="col-md-2"></div>
			<div class="col-md-5 alert bg-dark">
				<h1 class="text-warning block"> Type de recettes les plus communes </h1>
				<p class="text-light"> Voici le type : </p>
			</div>
		</div>
	</div>
</body>
